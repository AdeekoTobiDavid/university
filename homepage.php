...
<!--<form id="form1" name="form1" method="post" action="" >-->
 <form id="form1" name="form1" action="process1.php" method="post" >
  <table width="43%" border="1" align="center"  >
 
   <tr >
      <th width="49%" scope="row">Username</th>
      <td width="51%"><input type="text" name="matric" id="matric" /></td>
    </tr>
...
<div align="center"> 
    <strong><p><a href="logen.php">SIGN IN</a></p></strong>
	<strong><p><a href="background.php">logout</a></p></strong>
</body>
</html>