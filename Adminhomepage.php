...
<!--<form id="form1" name="form1" method="post" action="" >-->
 <form id="form1" name="form1" action="processAmin.php" method="post" >
  <table width="43%" border="1" align="center"  >
 
   <tr >
      <th width="49%" scope="row">Username</th>
      <td width="51%"><input type="text" name="username" id="username" /></td>
    </tr>
	
    <tr>
      <th scope="row">Password</th>
      <td><input type="passward" name="passward" id="passward" /></td>
    </tr>
	
    <tr>
      <th scope="row"><input type="submit" name="Login" id="Login" value="Login" /></th>
      <td><input type="submit" name="Reset" id="Reset" value="Reset" /></td>
    </tr>
  </table>
</form>
<div align="center"> 
    <strong><p><a href="staffs.php">SIGN IN</a></p></strong>
</body>
</html>