...
<!--<form id="form1" name="form1" method="post" action="" >-->
 <form id="form1" name="form1" action="processprofile.php" method="post" >
  <table width="43%" border="1" align="center"  >
 
   <tr >
      <th width="49%" scope="row">password</th>
      <td width="51%"><input type="text" name="passward" id="passward" /></td>
    </tr>
